...
insert into car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED,CAR_STATUS)
values(1, true, now(),  'GAS', 'MH02', 5, 4, 'BMW', false,'SELECT');

insert into car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED,CAR_STATUS)
values(2, true, now(),  'ELECTRIC', 'KA01', 4, 6, 'AUDI', false,'DESELECT');

insert into car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED,CAR_STATUS)
values(3, false, now(),  'DIESEL', 'OD41', 3, 3, 'FORD', false,'SELECT');
